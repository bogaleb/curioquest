...
import { Compass, Star, BookOpen, Shapes, Mountain, FlaskConical, Globe, Heart, ArrowRight, Volume2, ChevronDown, Check, Flag, Lightbulb, X, ShieldCheck, Sparkles, Leaf, LoaderCircle, Plus, Users } from 'lucide-react';
...
export default function HomePage() {
    ...
    {error && <div className="error" role="alert">{error} <button onClick={load}>Try again</button></div>}
        ...
        {view === 'rewards' && <TreasureChest profile={p} onNavigate={setView}/>}
