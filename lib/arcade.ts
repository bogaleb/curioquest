...
export const arcadeGames = [
  ...
  { id: "bubbles", title: "Bubble Pop", emoji: "🫧", color: "sky", subject: "reading", tagline: "Listen. Look. Pop!", description: "Pop every bubble that shares the sound Pip is listening for.", skills: "Listening · initial sounds · rhyme", missions: ["First sounds", "Rhyme time", "Sound detective"] },
  { id: "balance", title: "Balance Bay", emoji: "⚖️", color: "peach", subject: "math", tagline: "Which side tips down?", description: "Guess which side holds more, then watch the scale settle.", skills: "Comparing · counting · number sense", missions: ["More or fewer", "Even and equal", "Bigger numbers"] },
  { id: "stars", title: "Star Lines", emoji: "✨", color: "lavender", subject: "math", tagline: "Join the stars. Light the sky.", description: "Connect the stars in the right order to reveal a hidden picture.", skills: "Counting order · sequencing · patterns", missions: ["First pictures", "Longer trails", "Skip counting"] },
