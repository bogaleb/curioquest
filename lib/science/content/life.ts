          ...
          parts: [
            {
              ...
              y: 82,
              job: t3(
                "These do the drinking, down in the soil.",
                "Roots take up water from the soil, and hold the plant steady in the wind.",
                "Roots absorb water and dissolved minerals, and anchor the plant against wind and its own weight.",
              ),
            },
            {
              id: "stem",
              ...
              y: 55,
              job: t3(
                "This holds the plant up tall.",
                "The stem holds the plant up and carries water from the roots to the leaves.",
                "The stem provides support and contains the vessels that transport water up and sugars away.",
              ),
            },
            {
              id: "leaf",
              ...
              y: 44,
              job: t3(
                "These are the plant's food-makers. They catch the light.",
                "Leaves catch light and use it to make the plant's food.",
                "Leaves carry out photosynthesis, using light energy to build sugars from carbon dioxide and water.",
              ),
            },
            {
              id: "flower",
              ...
              y: 20,
              job: t3(
                "This is the pretty part that makes new seeds.",
                "The flower makes seeds, so there can be new plants.",
                "The flower is the reproductive structure; pollination there leads to seeds.",
              ),
            },
          ],
        },
          ...
          parts: [
            {
              ...
              job: t3(
                ...
                "Cover: a frog can hide here from herons and other predators.",
                "Cover from predators, and a surface for insect larvae and emerging adults.",
              ),
            },
            {
              id: "shallow",
              ...
              job: t3(
                ...
                "Warmer water speeds development, and the shallows keep spawn away from deep-water predators.",
              ),
            },
            {
              id: "surface",
              ...
              job: t3(
                ...
                "Where an adult frog comes up to breathe air with its lungs.",
                "The gas-exchange boundary: adult frogs surface to breathe, and oxygen dissolves into the water here.",
              ),
            },
            {
              id: "bottom",
              ...
              job: t3(
                ...
                "A thermal refuge: mud stays above freezing, allowing overwintering at a very low metabolic rate.",
              ),
            },
          ],
        },
