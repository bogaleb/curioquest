          ...
          parts: [
            {
              ...
              job: t2(
                ...
                "The pinna collects sound waves over a wide area and funnels them into the canal.",
              ),
            },
            {
              id: "canal",
              label: t2("The tunnel", "Ear canal"),
              x: 45,
              y: 50,
              job: t2(
                "A little tunnel that carries the shaking air further in.",
                "The canal carries the pressure wave inward to the eardrum.",
              ),
            },
            {
              id: "drum",
              ...
              y: 50,
              job: t2(
                "A tiny skin stretched tight. The shaking air makes it shake too — just like the drum with rice on it.",
            ...
            },
            {
              ...
              job: t2(
                ...
                "Converted signals travel along the auditory nerve to the brain, where they are interpreted.",
              ),
            },
          ],
        },
          ...
          parts: [
            {
              ...
              job: t3(
                ...
                "The brain does the thinking, remembering and deciding, and sends messages to everything else.",
                "The brain processes incoming signals, stores and retrieves information, and coordinates the rest of the body through the nervous system.",
              ),
            },
            {
              id: "heart",
              ...
              job: t3(
                ...
                "The heart is a muscle that pumps blood around your whole body, without ever stopping to rest.",
                "The heart is a muscular pump that circulates blood, delivering oxygen and nutrients and removing waste.",
              ),
            },
            {
              id: "lungs",
              ...
              job: t3(
                ...
                "The lungs take in air so your blood can collect the oxygen from it.",
                "The lungs exchange gases: oxygen passes into the blood and carbon dioxide passes out.",
              ),
            },
            {
              id: "bones",
              ...
              y: 62,
              job: t3(
                "These are hard inside you, and they hold you up.",
                "Bones hold you up, give you your shape, and protect the soft parts inside.",
                "The skeleton provides structural support, protects organs, and anchors muscles so that they can produce movement.",
              ),
            },
            {
              id: "muscle",
              ...
              y: 66,
              job: t3(
                "These pull on your bones so you can move.",
                "Muscles pull on bones to move them. They can pull, but they cannot push.",
                "Muscles generate movement by contracting, pulling on bones across joints. They work in opposing pairs because a muscle can only pull.",
              ),
            },
          ],
        },
